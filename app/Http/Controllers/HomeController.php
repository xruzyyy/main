...
public function edit($id)
{
    ...
    // Fetch the authenticated user and their associated listing
    $user = User::findOrFail($id);
    $listing = Posts::where('user_id', auth()->user()->id)->firstOrFail();
...
public function update(Request $request, $id)
{
    ...
    $listing = Posts::where('user_id', auth()->user()->id)->findOrFail($id);
