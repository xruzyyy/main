                    ...
                    <div class="field">
                        ...
                        <div class="control">
                            <input type="time" id="mondayOpen" name="mondayOpen"
                                value="{{ old('mondayOpen', $listing->mondayOpen) }}">
                            <input type="time" id="mondayClose" name="mondayClose"
                                value="{{ old('mondayClose', $listing->mondayClose) }}">
                        </div>
                    </div>
                    <div class="field">
                        ...
                        <div class="control">
                            <input type="time" id="tuesdayOpen" name="tuesdayOpen"
                                value="{{ old('tuesdayOpen', $listing->tuesdayOpen) }}">
                            <input type="time" id="tuesdayClose" name="tuesdayClose"
                                value="{{ old('tuesdayClose', $listing->tuesdayClose) }}">
                        </div>
                    </div>
                    <div class="field">
                        ...
                        <div class="control">
                            <input type="time" id="wednesdayOpen" name="wednesdayOpen"
                                value="{{ old('wednesdayOpen', $listing->wednesdayOpen) }}">
                            <input type="time" id="wednesdayClose" name="wednesdayClose"
                                value="{{ old('wednesdayClose', $listing->wednesdayClose) }}">
                        </div>
                    </div>
                    <div class="field">
                        ...
                        <div class="control">
                            <input type="time" id="thursdayOpen" name="thursdayOpen"
                                value="{{ old('thursdayOpen', $listing->thursdayOpen) }}">
                            <input type="time" id="thursdayClose" name="thursdayClose"
                                value="{{ old('thursdayClose', $listing->thursdayClose) }}">
                        </div>
                    </div>
                    <div class="field">
                        ...
                        <div class="control">
                            <input type="time" id="fridayOpen" name="fridayOpen"
                                value="{{ old('fridayOpen', $listing->fridayOpen) }}">
                            <input type="time" id="fridayClose" name="fridayClose"
                                value="{{ old('fridayClose', $listing->fridayClose) }}">
                        </div>
                    </div>
                    <div class="field">
                        ...
                        <div class="control">
                            <input type="time" id="saturdayOpen" name="saturdayOpen"
                                value="{{ old('saturdayOpen', $listing->saturdayOpen) }}">
                            <input type="time" id="saturdayClose" name="saturdayClose"
                                value="{{ old('saturdayClose', $listing->saturdayClose) }}">
                        </div>
                    </div>
                    <div class="field">
                        ...
                        <div class="control">
                            <input type="time" id="sundayOpen" name="sundayOpen"
                                value="{{ old('sundayOpen', $listing->sundayOpen) }}">
                            <input type="time" id="sundayClose" name="sundayClose"
                                value="{{ old('sundayClose', $listing->sundayClose) }}">
                        </div>
                    </div>
