    ...
    <ul class="dropdown-menu" aria-labelledby="combinedSortFilterButton">
        ...
        <li>
            <a class="dropdown-item {{ request()->input('filter') == 0 ? 'active' : '' }}"
                href="{{ route('users.sortTable', ['sort' => request()->input('sort', 'newest'), 'filter' => 0, 'limit' => request()->input('limit', 10)]) }}">Not
                Active</a>
        </li>
        <li>
            <a class="dropdown-item {{ request()->input('filter') == 3 ? 'active' : '' }}" href="{{ route('users.sortTable', ['sort' => request()->input('sort', 'newest'), 'filter' => 3, 'limit' => request()->input('limit', 10)]) }}">Disabled</a>
        </li>
    ...
    <ul class="dropdown-menu" aria-labelledby="paginationLimitButton">
        <li>
            <a class="dropdown-item {{ request()->input('limit', 5) == 5 ? 'active' : '' }}"
                href="{{ route('users', ['limit' => 5, 'sort' => request()->input('sort', 'newest')]) }}">5</a>
        </li>
        <li>
            <a class="dropdown-item {{ request()->input('limit', 10) == 10 ? 'active' : '' }}"
                href="{{ route('users', ['limit' => 10, 'sort' => request()->input('sort', 'newest')]) }}">10</a>
        </li>
        <li>
            <a class="dropdown-item {{ request()->input('limit', 20) == 20 ? 'active' : '' }}"
                href="{{ route('users', ['limit' => 20, 'sort' => request()->input('sort', 'newest')]) }}">20</a>
        </li>
        <li>
            <a class="dropdown-item {{ request()->input('limit', 50) == 50 ? 'active' : '' }}"
                href="{{ route('users', ['limit' => 50, 'sort' => request()->input('sort', 'newest')]) }}">50</a>
        </li>
        <li>
            <a class="dropdown-item {{ request()->input('limit', 100) == 100 ? 'active' : '' }}"
                href="{{ route('users', ['limit' => 100, 'sort' => request()->input('sort', 'newest')]) }}">100</a>
        </li>
        <li>
            <a class="dropdown-item {{ request()->input('limit') == 'all' ? 'active' : '' }}"
                href="{{ route('users', ['limit' => 'all', 'sort' => request()->input('sort', 'newest')]) }}">All</a>
        </li>
    </ul>
</div>
