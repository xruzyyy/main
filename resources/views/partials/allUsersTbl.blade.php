    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="#" class="btn btn-sm {{ $user->is_active ? 'btn-outline-danger' : 'btn-outline-success' }}" onclick="showConfirmationModal('{{ route('users.toggleStatus', $user->id) }}', {{ $user->is_active }}, '{{ $user->name }}')">
