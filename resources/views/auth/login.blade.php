				...
				<div class="form-container sign-up-container">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row align-items-center" id="business_permit_section" style="display: {{ old('type') == 'user' ? 'none' : 'block' }}">
							<label for="image" class="col-md-4 col-form-label text-md-center label-custom" style="margin-right: 1.5em;"><b>Permit <span style="color: red;">Required</span></b></label>
							<div class="col-md-6">
								<div class="input-group">
		...
		<div class="overlay-container">
			<div class="overlay">
				<div class="overlay-panel overlay-left">
					<h1>Welcome Back!</h1>
					<p style="font-family: Arial, sans-serif;">To keep connected with us please login with your personal info</p>
                    <a class="nav-link" id="signInView" href="{{ route('login') }}">{{ __('Login') }}</a>
				</div>
				<div class="overlay-panel overlay-right">
					<h1>Hello, There!</h1>
					<p style="font-family: Arial, sans-serif;">Enter your personal details and explore legit businesses</p>
