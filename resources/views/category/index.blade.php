...
@section('ManagePost')
                    ...
                    <div class="card-header">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a class="dropdown-item {{ request()->input('sort') == 'newest' ? 'active' : '' }}"
                                        href="{{ route('ManagePost', ['sort' => 'newest', 'filter' => request()->input('filter', 'all'), 'limit' => request()->input('limit', 10)]) }}">Newest</a>
                                </li>
                                <li>
                                    <a class="dropdown-item {{ request()->input('sort') == 'oldest' ? 'active' : '' }}"
                                        href="{{ route('ManagePost', ['sort' => 'oldest', 'filter' => request()->input('filter', 'all'), 'limit' => request()->input('limit', 10)]) }}">Oldest</a>
                                </li>
                                <li>
                                    <a class="dropdown-item {{ !request()->input('sort') ? 'active' : '' }}"
                                        href="{{ route('ManagePost', ['filter' => request()->input('filter', 'all'), 'limit' => request()->input('limit', 10)]) }}">Default</a>
                                </li>
                                <li class="dropdown-divider"></li>
                                <li>
                                    <a class="dropdown-item {{ request()->input('filter') == 'active' ? 'active' : '' }}"
                                        href="{{ route('ManagePost', ['sort' => request()->input('sort', 'newest'), 'filter' => 'active', 'limit' => request()->input('limit', 10)]) }}">Active</a>
                                </li>
                                <li>
                                    <a class="dropdown-item {{ request()->input('filter') == 'not_active' ? 'active' : '' }}"
                                        href="{{ route('ManagePost', ['sort' => request()->input('sort', 'newest'), 'filter' => 'not_active', 'limit' => request()->input('limit', 10)]) }}">Not
                                        Active</a>
                                </li>
                                <li>
                                    <a class="dropdown-item {{ !request()->input('filter') ? 'active' : '' }}"
                                        href="{{ route('ManagePost', ['sort' => request()->input('sort', 'newest'), 'limit' => request()->input('limit', 10)]) }}">All</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="dropdown float-end">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <li>
                                    <a class="dropdown-item {{ request()->input('limit', 10) == 5 ? 'active' : '' }}"
                                        href="{{ route('ManagePost', ['limit' => 5, 'sort' => request()->input('sort', 'newest')]) }}">5</a>
                                </li>
                                <li>
                                    <a class="dropdown-item {{ request()->input('limit', 10) == 10 ? 'active' : '' }}"
                                        href="{{ route('ManagePost', ['limit' => 10, 'sort' => request()->input('sort', 'newest')]) }}">10</a>
                                </li>
                                <li>
                                    <a class="dropdown-item {{ request()->input('limit', 10) == 20 ? 'active' : '' }}"
                                        href="{{ route('ManagePost', ['limit' => 20, 'sort' => request()->input('sort', 'newest')]) }}">20</a>
                                </li>
                                <li>
                                    <a class="dropdown-item {{ request()->input('limit', 10) == 50 ? 'active' : '' }}"
                                        href="{{ route('ManagePost', ['limit' => 50, 'sort' => request()->input('sort', 'newest')]) }}">50</a>
                                </li>
                                <li>
                                    <a class="dropdown-item {{ request()->input('limit', 10) == 100 ? 'active' : '' }}"
                                        href="{{ route('ManagePost', ['limit' => 100, 'sort' => request()->input('sort', 'newest')]) }}">100</a>
                                </li>
                                <li>
                                    <a class="dropdown-item {{ request()->input('limit') == 'all' ? 'active' : '' }}"
                                        href="{{ route('ManagePost', ['limit' => 'all', 'sort' => request()->input('sort', 'newest')]) }}">All</a>
                                </li>
                            </ul>
                        </div>
    ...
    @section('styles')
        <style>
            ...
            #backToTopBtn::before {
                content: "\f062";
                /* Unicode for FontAwesome arrow-up icon */
                font-family: "Font Awesome 5 Free";
                /* Use FontAwesome font family */
                font-weight: 900;
                font-size: 20px;
            }
