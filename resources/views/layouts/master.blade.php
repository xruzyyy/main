...
<div class="dropdown position-fixed bottom-0 end-0 mb-3 me-3 bd-mode-toggle" style="z-index: 1">
...
<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 position-relative">
            ...
            @yield('content')
            @yield('ManagePost')
            @yield('ManagePostEdit')
            @yield('ManagePostCreate')
            @yield('manageUsers')
