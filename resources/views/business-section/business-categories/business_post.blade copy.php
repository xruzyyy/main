...
<body>
    ...
    <!-- Rating form -->
    <form  style="text-align: left; margin-right:80%;" action="{{ route('ratings.store', $post->id) }}" method="POST" class="rating-form">
        @csrf
...
<form action="{{ route('comments.store', $post->id) }}" method="POST" class="comment-form">
    ...
    <div class="mb-3">
<textarea style="margin-top: 20px !important; width: 20em; background-color: #f5f5f5; border: 1px solid #ccc; padding: 10px; border-radius: 4px;" class="form-control" id="comment" name="content" rows="3" placeholder="Add your comment here"></textarea>
    </div>
