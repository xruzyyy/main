        ...
        <div class="row justify-content-center">
            <div class="col-lg-2 col-md-2 col-sm-4">
                <ul class="business-list">
                    ...
                    <li class="business-item">
                        ...
                        <span class="business-name">Fashion Photography Studios</span>
                    </li>
                </ul>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-4">
                <ul class="business-list">
                    ...
                    <li class="business-item">
                        ...
                        <span class="business-name">Barbershop</span>
                    </li>
                    <li class="business-item">
                        <i class="fas fa-chart-line business-icon"></i>
                        <span class="business-name">Fashion Consultancy</span>
                    </li>
                </ul>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-4">
                <ul class="business-list">
                    <li class="business-item">
                        ...
                        <span class="business-name">Beauty Salon</span>
                    </li>
                    <li class="business-item">
                    ...
                    <li class="business-item">
                        ...
                        <span class="business-name">Pattern Making Services</span>
                    </li>
                </ul>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-4">
                <ul class="business-list">
                    ...
                    <li class="business-item">
                        ...
                        <span class="business-name">Garment Manufacturing</span>
                    </li>
                    <li class="business-item">
                        <i class="fas fa-chalkboard-teacher business-icon"></i>
                        <span class="business-name">Fashion Events Management</span>
                    </li>
                </ul>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-4">
                <ul class="business-list">
                    <li class="business-item">
                        <i class="fas fa-store business-icon"></i>
                        <span class="business-name">Retail Clothing Stores</span>
                    </li>
                    <li class="business-item">
                        <i class="fas fa-palette business-icon"></i>
                        <span class="business-name">Fashion Design Studios</span>
                    </li>
                    <li class="business-item">
                        <i class="fas fa-shoe-prints business-icon"></i>
                        <span class="business-name">Shoe Manufacturing</span>
                    </li>
                    <li class="business-item">
                        <i class="fas fa-cut business-icon"></i>
                        <span class="business-name">Tailoring and Alterations</span>
                    </li>
                    <li class="business-item">
                        <i class="fas fa-print business-icon"></i>
                        <span class="business-name">Textile Printing and Embroidery</span>
                    </li>
                </ul>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-4">
                <ul class="business-list">
                    <li class="business-item">
                        ...
                        <span class="business-name">Fashion Accessories</span>
                    </li>
                    <li class="business-item">
                        <i class="fas fa-shopping-bag business-icon"></i>
                        <span class="business-name">Boutiques</span>
                    </li>
                    <li class="business-item">
                        <i class="fas fa-recycle business-icon"></i>
                        <span class="business-name">Apparel Recycling and Upcycling</span>
                    </li>
                    <li class="business-item">
                        <i class="fas fa-industry business-icon"></i>
                        <span class="business-name">Apparel Exporters</span>
                    </li>
            ...
            <div class="col-lg-2 col-md-2 col-sm-4">
                <ul class="business-list">
                    ...
                    <!-- Add your other business items here -->
                </ul>
            </div>
        </div>
