                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="rounded-image-container">
                                    ...
                                    <img class="rounded-image" src="{{ asset($account->profile_image) }}" alt="">
                                </div>
                            </td>
                            <td>{{ $account->name }}</td>
                            <td>{{ $account->email }}</td>
...
<style>
    ...
    #pendingAccountsTable_filter input {
    ...
    #pendingAccountsTable_filter input:focus {
        border-color: #007bff;
        outline: none;
    }

    #pendingAccountsTable_paginate .paginate_button {
        padding: 8px 15px;
        margin: 0 5px;
        border-radius: 20px;
    ...
    #pendingAccountsTable_paginate .paginate_button:hover {
        background-color: #0056b3;
    }

    #pendingAccountsTable_paginate .paginate_button.disabled {
        background-color: #6c757d;
    }

    #pendingAccountsTable_paginate .paginate_button.current {
        background-color: #0056b3;
    }
